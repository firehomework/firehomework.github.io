...
numberDataElement.innerHTML = 
    "<div class='my-tr'><span>{{roomNum}}</span><p>当前大厅数量</p></div>"+
    "<div class='my-tr'><span>{{playerNum}}</span><p>当前游玩人数</p></div>"+
    "<div class='my-tr'><span>{{playerList}}</span><p>正在游玩</p></div>"
const chartDataElement = document.createElement("div")
chartDataElement.style.height = "300px"
chartDataElement.id = "chart_show"
function initTB(elementId,myOption) {
    const callback = {
        roomNum:null,
        playerNum:null,
        playerList:null
